...
For production workloads, prefer the maintained [Explorer API](https://api.ergoplatform.com/api/v1/docs/) or run an [indexed node](indexed-node.md) instead of depending on an unmaintained public mirror.
