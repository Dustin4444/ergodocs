...
- The [EIP-0045 Rust reproduction companion](https://github.com/a-shannon/eip0045) provides checkpoint workflows, retained-ancestry encoding checks, and scoped negative-case validation for candidate proofs. Its [current checkpoint](https://github.com/a-shannon/eip0045/commit/7317835a5e7bf0d3027d4775f0711c8c0acf6359) is research tooling: the complete corpus, authenticated proof replay, consensus-cost measurements, activation transition, independent reproduction, and node/admission integration remain open.
