...
Use this section to learn Ergo protocol concepts, research, cryptography, scaling, and background knowledge. If you want to build, operate, or mine, use the dedicated sections after you understand the concepts you need.

## Choose a Learning Path

| Goal | Start here | Then read |
| --- | --- | --- |
| Understand Ergo's design | [Why Ergo](why.md) | [eUTXO](eutxo.md), [Storage Rent](storage-rent.md), [Sigma-6](sigma-6.md) |
| Learn the transaction model | [eUTXO](eutxo.md) | [Boxes](box.md), [Transactions](transactions.md), [Data Inputs](read-only-inputs.md) |
| Learn light-client and sidechain concepts | [NIPoPoWs](nipopows.md) | [Light Clients](nipopow_nodes.md), [Sidechains](nipopow-sidechains.md) |
| Study cryptography | [Cryptography Overview](crypto.md) | [Sigma Protocols](sigma.md), [Zero-Knowledge Proofs](zkp.md) |
| Understand Proof of Work | [Autolykos](autolykos-protocol.md) | [Difficulty](difficulty.md), [Emission](emission.md), [ASIC Resistance](asic.md) |
| Read research material | [Research Library](documents.md) | [Whitepaper](whitepaper.md), [ErgoScript Whitepaper](ergoscript-whitepaper.md) |
...
- Want to build: go to [Developer Start](get-started.md).
- Want to operate infrastructure: go to [Deploy Ergo Infrastructure](interact.md).
- Want to mine: go to [Mining](mining-overview.md).
- Need definitions: use the [Glossary](glossary.md).
