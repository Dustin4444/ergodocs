...
- **Review the ErgOne initiative**: [ErgOne](ergone.md) is a Proof-of-Commitment Protocol (PoCoP) designed to reward participation in promoting and supporting the Ergo ecosystem. Its former hosted dashboard is no longer available; consult the project page and source before relying on it.
