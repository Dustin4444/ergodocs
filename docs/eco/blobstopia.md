...
The original domain and later IP-hosted recovery interface are no longer available. The project is not currently being updated; review the [source repository](https://github.com/ThierryM1212/blobs-topia) before attempting recovery or reuse.
///

Blob's Topia is a game on Ergo blockchain in which you can own blob-fighter smart contracts.
